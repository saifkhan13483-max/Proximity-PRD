...
export default function Testimonials() {
  return (
    <>
      <section className="pt-32 pb-16 bg-dark-hero relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
          ...
          <h1 className="font-heading font-extrabold text-5xl md:text-6xl text-white mb-6">
            Real Results, Real <span className="text-gold-gradient">People</span>
          </h1>
      ...
      {/* Trust Badges */}
      <div className="bg-dark-card border-y border-gold-primary/10 py-8">
      ...
      <SectionWrapper className="bg-offwhite">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-dark-hero rounded-2xl aspect-video max-w-3xl mx-auto mb-16 flex items-center justify-center relative overflow-hidden border border-gold-primary/20 cursor-pointer group"
          >
            <div className="absolute inset-0 bg-gold-glow" />
            <div className="relative z-10 text-center">
              <div className="w-20 h-20 bg-gold-gradient rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl shadow-gold-primary/30 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <motion.div
                ...
                className="bg-white rounded-2xl p-8 shadow-sm border border-gold-primary/10 relative"
              >
                ...
                <p className="text-dark-charcoal/80 text-sm leading-relaxed mb-6 italic relative z-10">"{t.quote}"</p>
                <div className="flex justify-between items-center border-t border-gold-primary/10 pt-4">
                  <div>
                    <p className="font-heading font-semibold text-dark-charcoal text-sm">{t.name}</p>
                    <p className="text-muted text-xs">{t.city} · {t.timeframe}</p>
                  </div>
                  <div className="flex items-center gap-1 bg-offwhite rounded-full px-3 py-1.5">
      ...
      <section className="bg-dark-hero py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl text-center relative z-10">
          ...
          <Link to="/contact">
            <Button size="lg">Get Started Free <ArrowRight size={20} /></Button>
          </Link>
        </div>
      </section>
    </>
